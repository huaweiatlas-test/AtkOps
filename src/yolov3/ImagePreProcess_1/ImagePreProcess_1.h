...
#ifndef IMAG_PRE_PROCESS_1_H
#define IMAG_PRE_PROCESS_1_H
...
typedef struct DvppPreprocessInfo {
    ...
    uint32_t reserverd[IMAGE_ARRAY_LEN];
} DvppPreprocessInfo;
...
private:
    ...
    bool ProcessCrop(VpcUserCropConfigure &area, const int &width, const int &height, const int &realWidth,
